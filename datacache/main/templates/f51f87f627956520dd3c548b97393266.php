		...
		<div class="pagecontent margintleft10">
			<div class="pagecontentstr">
				...
				<div class="righttext center lineheight200 margintop8"> 
					<?php echo $this->timeformat($this->_tpl_vars['read']['addtime'],3) ?>  <?php echo $this->_tpl_vars['read']['author'] ?> <?php echo $this->_tpl_vars['read']['source'] ?> Click： <script type="text/javascript" src="<?php echo $this->_tpl_vars['rootdir'] ?>index.php?ac=scriptout&at=click&did=<?php echo $this->_tpl_vars['read']['did'] ?>"></script>
					<?php if(count($this->_tpl_vars['tag'])>0){ ?>
						<br/>
						<span class="strong padding-right3"> Tips：</span>
				...
				<div class="righttext_padding lineheight200 margintop8"><?php echo $this->_tpl_vars['read']['content'] ?></div>
						...
						<tr>
							<td align="left">
								214adb21252b0af7b03s214s9plist|did:<?php echo $this->_tpl_vars['read']['did'] ?>|60af7b03s21fs
									<?php if($this->_tpl_vars['read']['ctitle']!=''){ ?><a title="<?php echo $this->_tpl_vars['read']['title'] ?>" href="<?php echo $this->_tpl_vars['read']['link'] ?>"><?php echo $this->_tpl_vars['read']['ctitle'] ?></a><?php } ?>
								214adb21252b0af7b03s214s9
							</td>
							<td align="right">
