<div class="logo">
	<table style="width: 100%">
		<tr>
			<td style="width:238px;"><img title="logo" src="<?php echo $this->_tpl_vars['rootpath'] ?>images/logo.jpg"/></td>
			<td valign="top" class="padding-right3">
				<table style="width: 100%">
					...
					<tr>
						<td class="right" ><img title="tel" src="<?php echo $this->_tpl_vars['rootpath'] ?>images/telonline.jpg"/></td>
					</tr>
				</table>
			</td>
		</tr>
