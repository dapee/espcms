				...
				<ul class="joblist">
					...
					<li>
						<table width="100%" class="formlist3">
							<tr>
								<td class="line right">Download Name：</td>
								<td class="left strong colorgreen"><span style="float: right;"><a target="_blank" href="<?php echo $this->_tpl_vars['array'][$i]['downloadurl'] ?>" title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" class="infolist_orning">Download</a></span><?php echo $this->_tpl_vars['array'][$i]['ctitle'] ?></td>
							</tr>
							<tr>
								<td class="line right">Time：</td>
								<td class="left"><?php echo $this->timeformat($this->_tpl_vars['array'][$i]['addtime'],2) ?></td>
							</tr>
							<tr>
								<td class="line right" valign="top">Download Overview：</td>
