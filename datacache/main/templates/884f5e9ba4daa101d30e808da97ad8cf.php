					...
					<li>
						<table width="100%" class="formlist3">
							<tr>
								...
								<td class="left strong colorgreen"><span style="float: right;"><a href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>" title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" class="infolist_orning">Candidates</a></span><?php echo $this->_tpl_vars['array'][$i]['ctitle'] ?></td>
							</tr>
							<tr>
