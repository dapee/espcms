...
<div class="head">
	...
	<div class="framecenter margintop10">
		<div class="frameright ">
			...
			<div class="fcontent3">
				214adb21252b0af7b03s214s9typelist|tid:<?php echo $this->_tpl_vars['type']['tid'] ?>,utid:<?php echo $this->_tpl_vars['type']['upid'] ?>,level:3|60af7b03s21fs
				<ul class="three">
			...
			<div class="pagelist center">
				<ul class="goodslist">
					...
					<li>
						...
						<p>订购价格：<em><?php echo $this->_tpl_vars['array'][$i]['bprice'] ?></em>元</p>
						<p><a href="<?php echo $this->_tpl_vars['array'][$i]['enqlink'] ?>">我要询价</a> <a href="<?php echo $this->_tpl_vars['array'][$i]['buylink'] ?>">我要订购</a></p>
					</li>
					<?php }} ?>
				</ul>
			</div>
