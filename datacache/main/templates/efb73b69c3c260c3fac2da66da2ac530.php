			...
			<div class="pagecontentstr">
				<div class="righttext center">
					...
					<div class="readtitle">
						<dl>
							...
							<dd>产品编号：<strong class="priceclass"><?php echo $this->_tpl_vars['read']['tsn'] ?></strong></dd>
							<dd class="fastline">市场价格：<strong class="priceclass">￥<?php echo $this->_tpl_vars['read']['oprice'] ?></strong>元</dd>
							<dd>购买价格：<strong class="priceclass">￥<?php echo $this->_tpl_vars['read']['bprice'] ?></strong>元</dd>
							<dd>
							...
							<dd class="orderbotton"><a target="_blank" class="btninfo1" href="<?php echo $this->_tpl_vars['read']['buylink'] ?>">我要购买</a>&nbsp;&nbsp; <a target="_blank" class="btninfo2" href="<?php echo $this->_tpl_vars['read']['enqlink'] ?>">我要询价</a></dd>
						</dl>
					</div>
				</div>
				...
				<div class="righttext">
					<div class="readlist">
						...
						<div class="l lineheight200 fonttextindent2em" style="padding-left: 10px;padding-right:10px;"><?php echo $this->_tpl_vars['read']['content'] ?></div>
					</div>
				</div>
						...
						<div class="l">
							<ul class="piclist">
								...
								<li title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>">
									...
									<span class="t"><a class="infolist" title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><?php echo $this->cutstr($this->_tpl_vars['array'][$i]['title'],10,'') ?></a></span><p>购买价：<em><?php echo $this->_tpl_vars['array'][$i]['bprice'] ?></em>元</p>
								</li>
								<?php }} ?>
								214adb21252b0af7b03s214s9
							</ul>
