	...
	<div class="framecenter margintop10">
		<div class="frameleft">
			<div class="aboutcontent">
				214adb21252b0af7b03s214s9bread|tid:3|60af7b03s21fs
			...
			<div class="fup margintop10"><span class="spantitle">最新产品</span><span class="spanmone"><a class="morn" href="bbb4912cd04e6fd3type|5|linkbbb4912cd04e6fd3">更多产品</a></span></div>
			<div class="fcontent">
		...
		<div class="frameright margintleft10">
			<div class="fup"><span class="spantitle">最新消息</span><span class="spanmone"><a class="morn" href="bbb4912cd04e6fd3type|4|linkbbb4912cd04e6fd3">更多新闻</a></span></div>
			<div class="fcontent">
				<ul class="textlist">
				214adb21252b0af7b03s214s9list|mid:1,max:7|60af7b03s21fs
					<?php if (count($this->_tpl_vars['array'])>0){$divid_i=1;for($i=0;$i<count($this->_tpl_vars['array']); $i++){?>
					<li><a class="infolist" title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><?php echo $this->_tpl_vars['array'][$i]['ctitle'] ?></a></li>
					<?php }} ?>
				214adb21252b0af7b03s214s9
				</ul>
			</div>
			...
			<div class="fcontent1">
				214adb21252b0af7b03s214s9search|mid:3,tid:5,att:0|60af7b03s21fs
