			...
			<div class="pagecontentstr">
				<div class="righttext margintop8">
					<table width="100%" class="formlist3">
						<tr>
							<td class="line right">Post：</td>
							<td class="left strong colorgreen"><?php echo $this->_tpl_vars['read']['title'] ?></td>
						</tr>
						<tr>
							<td class="line right">Time：</td>
							<td class="left"><?php echo $this->timeformat($this->_tpl_vars['read']['addtime'],3) ?></td>
						</tr>
						<tr>
							<td class="line right" valign="top">Job requirements：</td>
							<td class="left lineheight200"><?php echo $this->_tpl_vars['read']['content'] ?></td>
						</tr>
					</table> 
				</div>
				
				<?php if($this->_tpl_vars['read']['fgid']!=0){ ?>
				<div class="righttext">
					<div class="readlist">
						6623ef97c6f6ccf2fb032e800d2edda9form|fgid:<?php echo $this->_tpl_vars['read']['fgid'] ?>,did:<?php echo $this->_tpl_vars['read']['did'] ?>||6623ef97c6f6ccf2fb032e800d2edda9
					</div>
				</div>
				<?php } ?>
			</div>
