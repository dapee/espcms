...
<div class="head">
	...
	<div class="bann">
		<div class="location">6623ef97c6f6ccf2fb032e800d2edda9path|type:type,id:<?php echo $this->_tpl_vars['type']['tid'] ?>||6623ef97c6f6ccf2fb032e800d2edda9</div>
	</div>
	...
	<div class="framecenter margintop10">
		<div class="frameright ">
			...
			<div class="fup3 margintop5"><span class="spantitle">Popular Brands</span></div>
			<div class="fcontent3">
				214adb21252b0af7b03s214s9subtype|mid:<?php echo $this->_tpl_vars['type']['mid'] ?>|60af7b03s21fs
				<ul class="three">
					<?php if (count($this->_tpl_vars['array'])>0){$divid_i=1;for($i=0;$i<count($this->_tpl_vars['array']); $i++){?>
						<li class="b"><a class="typelink" title="<?php echo $this->_tpl_vars['array'][$i]['subjectname'] ?>" href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><?php echo $this->_tpl_vars['array'][$i]['subjectname'] ?></a></li>
					<?php }} ?>
				</ul>
				214adb21252b0af7b03s214s9
			</div>
			...
			<div class="pagelist center">
				<ul class="goodslist">
					...
					<li>
						...
						<span class="t"><a class="infolist" title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><?php echo $this->_tpl_vars['array'][$i]['ctitle'] ?></a></span>
						<p>Price：<em>$<?php echo $this->_tpl_vars['array'][$i]['bprice'] ?></em></p>
						<p><a href="<?php echo $this->_tpl_vars['array'][$i]['enqlink'] ?>">INQUIRY</a> <a href="<?php echo $this->_tpl_vars['array'][$i]['buylink'] ?>">ADD TO CART</a></p>
					</li>
					<?php }} ?>
				</ul>
			</div>
